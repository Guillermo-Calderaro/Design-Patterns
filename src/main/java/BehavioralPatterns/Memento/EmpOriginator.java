...
public class EmpOriginator {
    ...
    public PlayerMemento saveToMemento() {
        PlayerMemento playerMemento =new PlayerMemento(this.empId, this.empName, this.empPhoneNo, this.empDesignation );
        return playerMemento;
    }
    public  void undoFromMemento(PlayerMemento memento)
    {
        this.empId = memento.getEmpId();
        this.empName = memento.getPlayerName();
